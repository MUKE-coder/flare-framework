 ...
 * the two-factor plugin (user.two_factor_enabled, two_factor) and passkeys (passkey).
 * Every sign-in method's tables exist whether or not lib/auth-config.ts switches it on.
