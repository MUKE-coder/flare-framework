/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f73c74af52e8f3b9019e7f5527d8313b)
// Runtime types generated with workerd@1.20260915.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	VINEXT_KV_CACHE: KVNamespace;
	FLARE_SECURITY: KVNamespace;
	STORAGE: R2Bucket;
	DB: D1Database;
	FLARE_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	...
	FLARE_SECURITY_MONITOR: DurableObjectNamespace<import("./worker/index").SecurityMonitor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "RealtimeChannel" | "SecurityMonitor";
	}
